...
$urut = 1;
if ($latestid) {
    $latestNumber = (int) substr($latestid['id_penghargaan'], 8);  // Ambil 3 digit terakhir dari id_peringatan
    $urut = $latestNumber + 1;
}
$newid = 'Achivement' . date('Y') . date('m') . str_pad($urut, 3, '0', STR_PAD_LEFT);
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="add_penghargaan.php" method="post">
                    <div class="mb-3">
                        <label for="id_peringatan" class="form-label">Kode Penghargaan</label>
                        <input type="text" class="form-control" id="id_peringatan" name="id_penghargaan" value="<?php echo htmlspecialchars($newid); ?>" readonly>
                    </div>
                    <div class="mb-3">
...
<script>
    document.addEventListener('click', function (e) {
        if (e.target && e.target.matches('.edit-btn')) {
            ...
            document.getElementById('edit_id_peenghargaan').value = id_penghargaan;

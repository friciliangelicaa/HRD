...
// Ambil data peringatan dengan nama pegawai dan alasan dari database
$query = "
...
$pdf->Cell(105, 10, 'Alasan', 1, 1, 'C'); // Lebar kolom alasan lebih besar untuk deskripsi
...
while ($row = $result->fetch_assoc()) {
    ...
    $pdf->Cell(105, 10, $row['alasan'], 1, 1, 'L'); // Alasan
}
